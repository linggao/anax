...
// This function archives the microservice instance and delete the secret details for this instance.
...
func (w *GovernanceWorker) ArchiveMicroserviceAndSecret(instKey string) error {
	if err := persistence.ArchiveMicroserviceInstAndDef(w.db, instKey); err != nil {
		return err
	}

	// TODO: delete the secret details for this instance
